    ...
    ?>
            ...
            <div class="div-tela-chamados" id="div-tela-chamados">
                <div class="legenda">
                    <div class="imagem-chamado">
                        <img src="/Helpdesk/Image/icone-ponto-velti.png" alt="">
                        <h2>Chamados - Ponto Eletrônico</h2>
                    </div>
                ...
                <div class="meus-chamados">
                    <?php
                    $sql = "SELECT * FROM Ponto WHERE Servidor_idServidor = $idServidor ORDER BY CASE status
                            ...
                            <div class="chamado">
                                ...
                                <div class="opcoes-chamado">
                                    <div class="opcao-editar">
                                        <a href="#" title="Editar" onclick="editarChamado('<?php echo $exibir['idPonto'] ?>','<?php echo $exibir['NumOS'] ?>')"><i class="fas fa-eye"></i></a>
                                    </div>
                                    ...
                                    ?>
                                        <div class="opcao-excluir">
                                            <a href="#" title="Excluir" onclick="excluirChamado('<?php echo $exibir['idPonto'] ?>','<?php echo $exibir['NumOS'] ?>', 'Ponto')"><i class="fas fa-trash-alt"></i></a>
                                        </div>
                                    ...
                                    ?>
                                        <div class="opcao-concluir">
                                            <a href="#" title="Concluir o serviço" onclick="concluirChamado('<?php echo $exibir['idPonto'] ?>','<?php echo $exibir['NumOS'] ?>','Ponto')"><i class="fa fa-handshake-o"></i></a>
                                        </div>
                                    <?php
                                    }
                                    ?>
        ...
        <div class="passos-problema" id="passos-problema" style="display: none;">
            ...
            <div class="categoria-chamado">
                <!-- Imagem do chamado -->
                <img src="/Helpdesk/Image/icone-ponto-velti.png" alt="Imagem computador">
        ...
        <div class="div-formulario-chamado" id="modalFormulario" style="display: none;">
            ...
            <form action="#" class="formulario-chamado">
                ...
                <div class="categoria-chamado">
                    <!-- Imagem do chamado -->
                    <img src="/Helpdesk/Image/icone-ponto-velti.png" alt="Imagem ponto">
